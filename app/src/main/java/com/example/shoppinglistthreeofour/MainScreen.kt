...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun EditShoppingItem(shoppingItem: ShoppingItem, onEditDone: (String, String, Int) -> Unit, onDismissRequest: () -> Unit) {
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    colors = ButtonDefaults.buttonColors(containerColor = Color.Red),
                    onClick = {
                        onEditDone(shoppingItem.title, shoppingItem.description, shoppingItem.quantity)
                    }
                ) {
                    Text("Cancel")
                }
